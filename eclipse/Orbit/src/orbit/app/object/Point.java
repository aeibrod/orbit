...
public class Point extends Object3D {
	...
	public void randomPlaneOrbit(){

		float rand = Rand.randomf(0, (float) Math.PI * 2);

		points[0].setX((float) (radius * Math.cos(rand)));
		points[0].setZ((float) (radius * Math.sin(rand)));
		points[0].setY(0);

		points[1].setX(points[0].getZ());
		points[1].setZ(-points[0].getX());
		points[1].setY(0);
